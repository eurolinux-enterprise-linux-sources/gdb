...
Patch559: gdb-core-threads-1of4.patch
Patch560: gdb-core-threads-2of4.patch
Patch561: gdb-core-threads-3of4.patch
Patch562: gdb-core-threads-4of4.patch
...
# Fix threading internal error on corrupted memory (BZ 739685).
...
# [vla] Disable the unfinished types garbage collector (BZ 682891).
# [vla] New testcase for the unfinished types garbage collector (for BZ 682891).
...
Patch584: gdb-bz694824-python-inline-frame-1of2.patch
Patch585: gdb-bz694824-python-inline-frame-2of2.patch

# Support -gdwarf-4 -fdebug-types-section debug info (Tom Tromey, BZ 718141).
Patch595: gdb-dwarf4-1of6.patch
Patch596: gdb-dwarf4-2of6.patch
Patch597: gdb-dwarf4-3of6.patch
Patch598: gdb-dwarf4-4of6.patch
Patch599: gdb-dwarf4-5of6.patch
Patch600: gdb-dwarf4-6of6.patch

# doc: make gdb's help a bit clearer re: ptype & whatis (BZ 704010).
Patch601: gdb-doc-ptype-whatis-1of2.patch
Patch602: gdb-doc-ptype-whatis-2of2.patch

# Fix printing of memory statistics (Tom Tromey, BZ 692386).
Patch603: gdb-print-statistics.patch

# Fix `info sources' output regression (BZ 712117).
Patch604: gdb-info-sources-1of2.patch
Patch605: gdb-info-sources-2of2.patch

# Support DW_AT_data_member_location even for DWARF <4 (Tom Tromey, BZ 702427).
Patch606: gdb-data-member-location-1of3.patch
Patch607: gdb-data-member-location-2of3.patch
Patch608: gdb-data-member-location-3of3.patch

# Core files should use linux-thread-db.c also on ppc and s390x (BZ 697900).
Patch609: gdb-core-threads-ibm.patch
Patch610: gdb-core-threads-test2.patch

# Fix case insensitive symbols for Fortran by iFort (BZ 669434).
Patch611: gdb-case-insensitive-1of5.patch
Patch612: gdb-case-insensitive-2of5.patch
Patch613: gdb-case-insensitive-3of5.patch
Patch614: gdb-case-insensitive-4of5.patch
Patch615: gdb-case-insensitive-5of5.patch

# Test GDB opcodes/ disassembly of Intel Ivy Bridge instructions (BZ 696890).
Patch616: gdb-test-ivy-bridge.patch

# SystemTap probes support (Sergio Durigan Junior, for BZ 669432).
Patch617: gdb-stap-1of6.patch
Patch618: gdb-stap-2of6.patch
Patch619: gdb-stap-3of6.patch
Patch620: gdb-stap-4of6.patch
Patch621: gdb-stap-5of6.patch
Patch622: gdb-stap-6of6.patch

# Improve GDB performance on inferior dlopen calls (Gary Benson, BZ 698001).
Patch623: gdb-dlopen-skip_inline_frames-perf.patch

# Fix dlopen of libpthread.so, updated glibc required (Gary Benson, BZ 669432).
Patch624: gdb-dlopen-stap-probe.patch
Patch625: gdb-dlopen-stap-probe-test.patch
# testsuite: Fix break-interp.exp expections for updated glibc (BZ 752834).
Patch644: gdb-dlopen-glibc-breakinterp.patch

# Fix runtime evaluation of strings, for gdb -write (Tom Tromey, BZ 730475).
Patch626: gdb-write-string.patch

# Fix cp_scan_for_anonymous_namespace crash (Aleksandar Ristovski, BZ 750341).
Patch636: gdb-anon-namespace-crash.patch
Patch643: gdb-anon-namespace-crash-test.patch

# [vla] Fix regression on no type for subrange from IBM XLF Fortran (BZ 806920).
Patch660: gdb-subrange-no-type.patch

# Fix `Cannot find new threads: generic error' (RH BZ 811648).
Patch741: gdb-rhbz-811648-cannot-find-new-threads-01of02.patch
Patch742: gdb-rhbz-811648-cannot-find-new-threads-02of02.patch

# Fix `CVE-2011-4355 gdb: arbitrary code execution via .debug_gdb_scripts'
# (RH BZ 756116).
Patch743: gdb-rhbz756116-autoload-01of49.patch
Patch744: gdb-rhbz756116-autoload-02of49.patch
Patch745: gdb-rhbz756116-autoload-03of49.patch
Patch746: gdb-rhbz756116-autoload-04of49.patch
Patch747: gdb-rhbz756116-autoload-05of49.patch
Patch748: gdb-rhbz756116-autoload-06of49.patch
Patch749: gdb-rhbz756116-autoload-07of49.patch
Patch750: gdb-rhbz756116-autoload-08of49.patch
Patch751: gdb-rhbz756116-autoload-09of49.patch
Patch752: gdb-rhbz756116-autoload-10of49.patch
Patch753: gdb-rhbz756116-autoload-11of49.patch
Patch754: gdb-rhbz756116-autoload-12of49.patch
Patch755: gdb-rhbz756116-autoload-13of49.patch
Patch756: gdb-rhbz756116-autoload-14of49.patch
Patch757: gdb-rhbz756116-autoload-15of49.patch
Patch758: gdb-rhbz756116-autoload-16of49.patch
Patch759: gdb-rhbz756116-autoload-17of49.patch
Patch760: gdb-rhbz756116-autoload-18of49.patch
Patch761: gdb-rhbz756116-autoload-19of49.patch
Patch762: gdb-rhbz756116-autoload-20of49.patch
Patch763: gdb-rhbz756116-autoload-21of49.patch
Patch764: gdb-rhbz756116-autoload-22of49.patch
Patch765: gdb-rhbz756116-autoload-23of49.patch
Patch766: gdb-rhbz756116-autoload-24of49.patch
Patch767: gdb-rhbz756116-autoload-25of49.patch
Patch768: gdb-rhbz756116-autoload-26of49.patch
Patch769: gdb-rhbz756116-autoload-27of49.patch
Patch770: gdb-rhbz756116-autoload-28of49.patch
Patch771: gdb-rhbz756116-autoload-29of49.patch
Patch772: gdb-rhbz756116-autoload-30of49.patch
Patch773: gdb-rhbz756116-autoload-31of49.patch
Patch774: gdb-rhbz756116-autoload-32of49.patch
Patch775: gdb-rhbz756116-autoload-33of49.patch
Patch776: gdb-rhbz756116-autoload-34of49.patch
Patch777: gdb-rhbz756116-autoload-35of49.patch
Patch778: gdb-rhbz756116-autoload-36of49.patch
Patch779: gdb-rhbz756116-autoload-37of49.patch
Patch780: gdb-rhbz756116-autoload-38of49.patch
Patch781: gdb-rhbz756116-autoload-39of49.patch
Patch782: gdb-rhbz756116-autoload-40of49.patch
Patch783: gdb-rhbz756116-autoload-41of49.patch
Patch784: gdb-rhbz756116-autoload-42of49.patch
Patch785: gdb-rhbz756116-autoload-43of49.patch
Patch786: gdb-rhbz756116-autoload-44of49.patch
Patch787: gdb-rhbz756116-autoload-45of49.patch
Patch788: gdb-rhbz756116-autoload-46of49.patch
Patch789: gdb-rhbz756116-autoload-47of49.patch
Patch790: gdb-rhbz756116-autoload-48of49.patch
Patch791: gdb-rhbz756116-autoload-49of49.patch

# Fix `GDB cannot access struct member whose offset is larger than 256MB'
# (RH BZ 795424).
Patch792: gdb-rhbz795424-bitpos-01of25.patch
Patch793: gdb-rhbz795424-bitpos-02of25.patch
Patch794: gdb-rhbz795424-bitpos-03of25.patch
Patch795: gdb-rhbz795424-bitpos-04of25.patch
Patch796: gdb-rhbz795424-bitpos-05of25.patch
...
# Fix `gdb can't find local static variables with gcc-4.4.6-3'
# (RH BZ #913623).
Patch823: gdb-rhbz913623-gnu-unique.patch

# Fix ` gdb no longer recognises "maintenance set python print-stack off"'
# (RH BZ 921685).
Patch824: gdb-rhbz921685-maint-set-python-print-stack.patch
...
- Fix `gdb/findvar.c:417: internal-error: read_var_value: Assertion `frame'
  failed.' (Tom Tromey, RH BZ 947564).

* Thu Apr 03 2013 Sergio Durigan Junior <sergiodj@redhat.com> - 7.2-63.el6
- Fix `gdb no longer recognises "maintenance set python print-stack off"'
  (RH BZ 921685).

* Mon Apr 01 2013 Sergio Durigan Junior <sergiodj@redhat.com> - 7.2-62.el6
- Update the patch to fix RH BZ 913623, in order to reflect the upstream
  version (RH BZ 913623).

* Tue Mar 05 2013 Sergio Durigan Junior <sergiodj@redhat.com> - 7.2-61.el6
- Fix `gdb can't find local static variables with gcc-4.4.6-3'
  (Alan Matsuoka, RH BZ 913623).

* Fri Oct 12 2012 Sergio Durigan Junior <sergiodj@redhat.com> - 7.2-60.el6
- Fix `GDB cannot access struct member whose offset is larger than 256MB'
  (Siddhesh Poyarekar, RH BZ 795424).

* Thu Sep 26 2012 Sergio Durigan Junior <sergiodj@redhat.com> - 7.2-59.el6
- Fix `CVE-2011-4355 gdb: arbitrary code execution via .debug_gdb_scripts'
  (Jan Kratochvil, RH BZ 756116).

* Sat Sep 15 2012 Sergio Durigan Junior <sergiodj@redhat.com> - 7.2-58.el6
- Fix `Cannot find new threads: generic error' (RH BZ 811648).
- Delete gdb-core-threads-5of5.patch; rename gdb-core-threads-Nof5.patch to gdb-core-threads-Nof4.patch.

* Sun Jul 15 2012 Sergio Durigan Junior <sergiodj@redhat.com> - 7.2-57.el6
- Fix `Backport gdb fix to handle identical binaries via additional build-id
  symlinks' (RH BZ 836966).

* Fri Apr 27 2012 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-56.el6
- Revert "set auto-load" patchset (revert BZ 756116).

* Tue Apr 24 2012 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-55.el6
- Update "set auto-load" patchset and the --with-auto-load-safe-path setting.

* Sat Apr 21 2012 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-54.el6
- Security fix for loading untrusted inferiors, see "set auto-load" (BZ 756116).

* Mon Mar 26 2012 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-53.el6
- [vla] Fix regression on no type for subrange from IBM XLF Fortran (BZ 806920).

* Wed Feb 29 2012 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-52.el6
- Make --enablerepo to use '*-debug*' for RHEL compatibility (BZ 781571).

* Sat Jan 14 2012 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-51.el6
- Fix threading internal error on corrupted memory (BZ 739685).
- Fix cp_scan_for_anonymous_namespace crash (Aleksandar Ristovski, BZ 750341).
- testsuite: Fix break-interp.exp expections for updated glibc (BZ 752834).

* Sun Aug 14 2011 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-50.el6
- Fix dlopen of libpthread.so, updated glibc required (Gary Benson, BZ 669432).
  - SystemTap probes support (Sergio Durigan Junior, for BZ 669432).
- Improve GDB performance on inferior dlopen calls (Gary Benson, BZ 698001).
- Fix runtime evaluation of strings, for gdb -write (Tom Tromey, BZ 730475).
- Fix dw2-simple-locdesc.S for better arch compatibility  (for BZ 702427).
- Fix dw2-case-insensitive.exp compatibility with ppc64 (for BZ 669434).
- Fix backport of core files PID also for s390x (for BZ 697900).

* Sun Aug  7 2011 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-49.el6
- Support -gdwarf-4 -fdebug-types-section debug info (Tom Tromey, BZ 718141).
- doc: make gdb's help a bit clearer re: ptype & whatis (BZ 704010).
- Fix printing of memory statistics (Tom Tromey, BZ 692386).
- Fix `info sources' output regression (BZ 712117).
...
* Tue Apr 12 2011 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-48.el6
- Fix Python access to inlined frames (BZ 694824).

* Wed Mar 23 2011 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-47.el6
- [ifunc] Fix ppc64 function descriptors compatibility.
- detach-as-stopped kernel workaround is now always active, not just on RHEL-5.

* Fri Mar 18 2011 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-46.el6
- Fix i386 rwatch+awatch before run (BZ 688788, on top of BZ 541866).

* Tue Mar  8 2011 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-45.el6
- [vla] Disable the unfinished types garbage collector (BZ 682891).
- [vla] New testcase for the unfinished types garbage collector (for BZ 682891).

* Mon Feb 21 2011 Jan Kratochvil <jan.kratochvil@redhat.com> - 7.2-44.el6
- Change the version string to "Red Hat Enterprise Linux" (BZ 649030).
